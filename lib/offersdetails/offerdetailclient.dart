                    ...
                    Positioned(
                        ...
                        child: ConditionalBuilder(condition: state is! LoadingExState, builder: (BuildContext context) {return MaterialButton(
                          onPressed: () {
                            ...
                            sendfava={
                              'offer_id' : '${CupitHome.get(context).allofferModel!.data!.offers[position!].id}',
                            };
                            CupitHome.get(context).changefav(data: sendfava,dd:CupitHome.get(context).colorfav);
                          },
                          shape: const CircleBorder(),
                          color: CupitHome.get(context).dartSwitch
                          ...
                          child: Icon(
                            ...
                            color: CupitHome.get(context).colorfav ? Colors.red : Colors.white,
                            // color: CupitHome.get(context).dartSwitch
                            //     ? Colors.white
                            //     : Colors.white,
                          ),
